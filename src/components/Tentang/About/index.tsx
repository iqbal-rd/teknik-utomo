    ...
    <div className="w-full">
      ...
      <motion.div
          ...
          <section className="overflow-x-hidden max-w-[430px] md:max-w-[744px] lg:max-w-[1440px] mx-auto px-[28px] md:px-[44px] lg:px-[88px] pt-[70px] md:pt-[90px] lg:pt-[160px]">
            <h2 className="text-base text-[#2F2D93] font-inter">Tentang Kami</h2>
            ...
            <p className="text-[#4F4F4F] text-[14px] md:text-[16px] lg:text-[18px] mb-2.5 md:mb-5 text-justify font-inter">
